...
Identify up to 3 non-Quick-Win gaps: Strategic (High impact + Medium/High effort), Low Priority (Low impact), or Reconsider (Low/Medium impact + High effort).
{"gaps":[{"id":"s-1","name":"5 words max","actionTitle":"verb-first 8 words","category":"People|Process|Technology|Culture|External","impact":"High|Medium|Low","effort":"High|Medium","cost":"High|Medium|Low","classification":"Strategic|Low Priority|Reconsider"}]}
Prefer Strategic over Low Priority. Skip off-limits items.`
  ...
  const readable = new ReadableStream({
    async start(controller) {
      try {
        ...
        console.error('[phase5/strategic] error:', err)
